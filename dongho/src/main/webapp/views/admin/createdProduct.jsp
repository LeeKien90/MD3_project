        ...
        <main class="content">
            <div class="container-fluid p-0">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="<%=request.getContextPath()%>/ProductServlet?action=Created" method="post" enctype="multipart/form-data">
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <tr>
                                <td colspan="2">
                                    <input type="submit" name="action" value="Created" class="btn btn-primary"/>
                                </td>
                            </tr>
                        </table>
                        </form>
