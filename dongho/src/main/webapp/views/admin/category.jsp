            ...
            <div class="container-fluid p-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${listCategory}" var="cat">
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" id="update" class="btn btn-warning" href="#updateCatalogModal"
                                           data-bs-toggle="modal">Update</a>
                                        <a type="button" id="delete" class="btn btn-danger" href="#deleteCatalogModal"
                        ...
                        <div class="modal fade" id="newCatalogModal" tabindex="-1" aria-hidden="true"
                             aria-labelledby="newCatalogLabel">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="newCatalogLabel">Create New Catalog</h4>
                                    ...
                                    <form action="<%=request.getContextPath()%>/CategoryServlet" method="post">
                                        <div class="modal-body">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-select" name="status" id="catalogStatus">
                        ...
                        <div class="modal fade" id="deleteCatalogModal" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="deleteCatalogModalLabel">Delete Catalog</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    <form action="<%=request.getContextPath()%>/CategoryServlet" method="post">
                                        <div class="modal-body">
                                            <p>Bạn chắc chắn muốn xóa danh mục ?</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                                                Close
                                            ...
                                            <input type="hidden" id="catDeleteId" name="catDeleteId"/>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="modal fade" id="updateCatalogModal" tabindex="-1" aria-hidden="true"
                             aria-labelledby="updateCatalogLabel">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="updateCatalogLabel">Update Catalog</h4>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    <form action="<%=request.getContextPath()%>/CategoryServlet" method="post">
                                        <div class="modal-body">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Catalog ID</span>
                                                </div>
                                                <input type="text" name="catalogId" id="updateCatalogId"
                                                       placeholder="catalog id"
                                                       class="form-control" aria-label="catalogId"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="catalogName" id="updateCatalogName"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="descriptions" id="updateDescriptions"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-select" name="updateStatus" id="updateCatalogStatus">
...
<script type="text/javascript">
    ...
    $(document).on('click', 'table #update', function () {
        ...
        $.ajax({
            type: 'GET',
            url: '${pageContext.request.contextPath}/CategoryServlet?action=getById&&catalogId=' + catId,
            success: function (catalogUpdate) {
                $('#updateCatalogId').val(catalogUpdate.catalogId);
                $('#updateCatalogName').val(catalogUpdate.catalogName);
                $('#updateDescriptions').val(catalogUpdate.descriptions);
                let status = catalogUpdate.updateStatus.toString();
                $('#updateCatalogStatus').val(status);
