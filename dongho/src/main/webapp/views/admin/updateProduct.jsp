        ...
        <main class="content">
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-header">
                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="<%=request.getContextPath()%>/ProductServlet?action=InitCreate">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="<%=request.getContextPath()%>/ProductServlet?action=Update" method="post" enctype="multipart/form-data">
                            <table id="example1" class="table table-bordered table-striped text-center">
                                <tr>
                                    <th>ID</th>
                                    <td><input type="text" value="${productUpdate.productId}" name="productId"></td>
                                </tr>
                                <tr>
                                    <th>Name</th>
                                    <td><input type="text" value="${productUpdate.productName}" name="productName"/></td>
                                </tr>
                                <tr>
                                    <th>Description</th>
                                  <td> <textarea type="text" id="descriptions" value="" name="descriptions">${productUpdate.productDescriptions}</textarea></td>
                                </tr>
                                <tr>
                                    <th>Price</th>
                                    <td><input type="text" value="${productUpdate.price}" name="price"/></td>
                                </tr>
                                <tr>
                                    <th>Quantity</th>
                                    <td><input type="number" value="${productUpdate.quantity}" name="quantity"/></td>
                                </tr>
                                <tr>
                                    <th>Status</th>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-select" name="parentId" id="catalogParent">
                                            ...
                                            <c:forEach items="${listCategory}" var="catParent">
                                                <option value="${catParent.catalogId}">${catParent.catalogName}</option>
                                            </c:forEach>
                                        </select>
                                    </td>
                                </tr>
