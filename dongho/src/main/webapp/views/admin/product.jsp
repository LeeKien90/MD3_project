                ...
                <ul class="navbar-nav navbar-align">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<%=request.getContextPath()%>/HomeServlet?action=Home">Log out</a>
                        </div>
                    </li>
                </ul>
            </div>
...
<%--                                    <td>${pro.catalogId}</td>--%>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/ProductServlet?action=Detail&&productId=${pro.productId}"><input type="submit" name="action" value="Detail" class="btn btn-primary"/></a>
                                        <a href="<%=request.getContextPath()%>/ProductServlet?action=Update&&productId=${pro.productId}"><input type="submit" name="action" value="Update" class="btn btn-warning"/></a>
                                        <a href="<%=request.getContextPath()%>/ProductServlet?action=Delete&&productId=${pro.productId}"><input type="submit" name="action" value="Delete" class="btn btn-danger"/></a>
                                    </td>
                                    <td>
