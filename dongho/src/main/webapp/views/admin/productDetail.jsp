        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-7">
                <div class="detail-box">
                    ...
                    <h3>Mô tả:</h3>
                    <p> ${productDetail.productDescriptions}</p>
                    <h3>Giá: $${productDetail.price}</h3>
                    <h5>Số lượng: ${productDetail.quantity}</h5>
                    <a href="<%=request.getContextPath()%>/ProductServlet?action=getAll"><input type="submit" name="action" value="<- Quay lại" class="btn btn-warning"/></a>
